...
menu.forEach(menu =>menuItems.innerHTML += sectionCreate(menu))
...
function changeMenu () {
  ...
  if (this.innerHTML === "All") {
    ...
    menuItems.innerHTML += sectionCreate(itemsName)
  })
  }
}
...
function newbuton (name = "All") {
    ...
    filterbuttons.appendChild(createbutton)
  }
